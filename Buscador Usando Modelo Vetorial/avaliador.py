...
def main():
    dic_esperados1 = ler_arquivo_esperado('./results/esperados.csv')
    dic_resultados1 = ler_arquivo_resultados('./results/resultados-stemmer.csv')
    dic_resultados2 = ler_arquivo_resultados('./results/resultados-nostemmer.csv')
